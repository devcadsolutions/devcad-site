      ...
      <section>
        <div className="container mx-auto max-w-2xl px-4 text-center animate-in fade-in slide-in-from-bottom-8 duration-700 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex justify-center gap-6 sm:gap-8">
            <a href="#" className="group flex flex-col items-center gap-2 text-muted-foreground transition-all duration-300 hover:-translate-y-2 hover:text-primary" title="LinkedIn">
              <div className="transition-transform duration-300 group-hover:scale-110">
                <LinkedInIcon />
              </div>
              <span>LinkedIn</span>
            </a>
            <a href="#" className="group flex flex-col items-center gap-2 text-muted-foreground transition-all duration-300 hover:-translate-y-2 hover:text-primary" title="WhatsApp">
              <div className="transition-transform duration-300 group-hover:scale-110">
                <WhatsAppIcon />
              </div>
              <span>WhatsApp</span>
            </a>
            <a href={`mailto:${siteConfig.links.email}`} className="group flex flex-col items-center gap-2 text-muted-foreground transition-all duration-300 hover:-translate-y-2 hover:text-primary" title="Email">
              <div className="transition-transform duration-300 group-hover:scale-110">
                <GmailIcon />
              </div>
              <span>Email</span>

       ...
       <section>
        <div className="container mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-12 flex justify-center gap-6 sm:gap-8">
                <a href="#" className="flex flex-col items-center gap-2 text-muted-foreground transition-colors hover:text-primary" title="LinkedIn">
                    <LinkedInIcon />
                    <span>LinkedIn</span>
                </a>
                <a href="#" className="flex flex-col items-center gap-2 text-muted-foreground transition-colors hover:text-primary" title="WhatsApp">
                    <WhatsAppIcon />
                    <span>WhatsApp</span>
                </a>
                <a href={`mailto:${siteConfig.links.email}`} className="flex flex-col items-center gap-2 text-muted-foreground transition-colors hover:text-primary" title="Email">
                   <GmailIcon />
                   <span>Email</span>
                </a>
            </div>
             <div className="mt-12 border-t pt-8 text-center text-muted-foreground">
                <p className="font-semibold">{siteConfig.links.email}</p>
